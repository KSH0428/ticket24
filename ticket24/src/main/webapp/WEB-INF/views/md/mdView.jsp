						...
						<div class="card text-bg-white mb-3 text-outline-bg-dark"
							...
							<div class="card-body">
								<span> <span>재고 <span class="fw-bold text-primary"><fmt:formatNumber
												value="${md.md_quantity}" /> </span></span> 
								...
								<div class="accordion-item">
									<h2 class="accordion-header">
										<button class="accordion-button" type="button"
											...
											<p class="text-end">
												<strong>[주문/결제/입금확인] </strong> 배송/교환/반품 문의를 빠르게 확인하려면 어떻게
												해야되나요?
											</p>
										</button>
									</h2>
									<div id="panelsStayOpen-collapseOne"
										...
										<div class="accordion-body">
											배송, 교환, 반품의 경우 판매자 측으로 직접 연락 시 고객센터를 통하지 않고 직접 판매자에게 빠르게 문의가
											가능하여 반품 배송,교환,반품 일정을 보다 빠르게 확인이 가능합니다. <br>
											<br> <strong>1.판매자 연락처 확인 방법 ( 판매자에게(구매 상품 발송
												주체) 직접 유선 문의 가능 )</strong> <br> [Web] <br> 공통:구매/구매 예정 상품
											상품페이지>스크롤 다운 시 노출되는 검은색 띠 內 반품/교환 클릭>하단 판매자 정보 구매상품 판매자 연락처 :
											로그인>오른쪽 상단 위 마이페이지>마이페이지>주문정보 오른쪽 끝 업체정보 클릭 <br>
											<br> [Mobile] <br> 공통:구매/구매 예정 상품 상품페이지>스크롤 다운 시
											노출되는 검은색 띠 內 판매정보 클릭 구매상품 판매자 연락처 : 로그인>아래 하단
											마이페이지(사람모양)>주문내역> 문의 필요한 주문정보 상세보기>판매자정보>전화하기 터치 <br>
											<br> (판매자 노출정보 : 판매자명 / 상호,대표자 / 연락처 / 응대가능시간 / 응대불가시간 /
											E-mail / 사업자등록번호 등) <br>
											<br> <strong>2.판매자 게시글 문의 방법</strong> <br> 공통 :
											구매/구매 예정 상품 상세페이지>스크롤 다운 시 노출되는 검은색 띠 內>상품문의 (문의) >문의글
											작성(비밀글/일반글) <br> 구매상품 : 로그인>마이페이지>상품문의 필요한 구매 상품 클릭>
											구매상품페이지 노출 시 스크롤 다운> 검은색 띠 內 상품문의>상품문의>문의글 작성(비밀글/일반글) <br>
											( ※ 상품문의 작성 시 개인정보가 작성되지 않도록 주의 부탁 드립니다. ) <br> <br>
											2개월 경과 구매상품 문의가 필요한 경우 리스트 상단 취소 주문 건 같이보기/구매내역 더보기>구매내역 더보기
											클릭
										</div>
									</div>
								</div>
								<div class="accordion-item">
									<h2 class="accordion-header">
										<button class="accordion-button collapsed" type="button"
											...
											<p class="text-end">
												<strong>[주문/결제/입금확인] </strong> 내 주문내역 확인은 어디에서 가능한가요?
											</p>
										</button>
									</h2>
									<div id="panelsStayOpen-collapseTwo"
										...
										<div class="accordion-body">
											<p class="text-danger">주문한 내역은 인터파크 홈페이지 로그인 후 [마이페이지]에서
												확인하실 수 있습니다.</p>
											<br>
											<b class="text-primary">[주문내역 확인 방법]</b> <br>
											<strong>[마이페이지 > 쇼핑내역 > 주문/배송조회]</strong> 에서 최근 2개월 주문내역을
											확인하실 수 있으며, 이전 주문은 날짜를 지정하셔서 조회하시면 됩니다.
										</div>
									</div>
								</div>
								<div class="accordion-item">
									<h2 class="accordion-header">
										<button class="accordion-button collapsed" type="button"
											...
											<p class="text-end">
												<strong>[배송문의] </strong> 발송완료 상태인데 아직 상품을 받지 못했어요!
											</p>
										</button>
									</h2>
									<div id="panelsStayOpen-collapseThree"
										...
										<div class="accordion-body">
											...
											<p class="text-danger">발송완료일로부터 1 ~ 2일 이내에 상품을 받아보실 수
												있습니다</p>
											<br> <strong>[배송조회 하기]</strong> <br> ① [마이페이지] >
											쇼핑내역 > 주문/배송조회] 에서 배송확인을 원하시는 주문의 오른쪽 택배/구매확정 아래 택배사 클릭 시 해당
											택배사로 배송조회 화면으로 이동합니다. <br> ② 택배사 사이트로 화면 이동 후 배송현황 확인
											가능하며, 발송된 후에는 해당 택배사로 문의하셔야 더욱 빠르게 배송상태를 알아보실 수 있습니다. <br>
											<br> <strong>[주문 상태가 발송완료이나 운송장번호가 조회되지 않는 것] </strong>
											<br>① 발송완료 일이 당일인 경우 택배사에 운송장정보가 전산에 등록되지 않은 것으로 다음날 다시
											한 번 조회를 부탁드립니다. <br>② 판매업체에서 직접 배송하는 상품은 배송조회가 안될 수
											있습니다. <br>③ 배송조회 후 판매업체에서 임의 혹은 실수로 운송장번호를 잘못 입력한 것으로
											판단되면 마이페이지 주문내역에서 [허위발송신고]를 하시거나 쇼핑 고객센터에 알려주시면 확인 후 배송현황을
											안내해 드리겠습니다.
										</div>
									</div>
								</div>
								<div class="accordion-item">
									<h2 class="accordion-header">
										<button class="accordion-button collapsed" type="button"
											...
											<p class="text-end">
												<strong>[회원정보/부가서비스] </strong> 아이디 / 비밀번호를 잊어버린 경우 어떻게 확인
												하나요?
											</p>
										</button>
									</h2>
									<div id="panelsStayOpen-collapseFour"
										...
										<div class="accordion-body">
											<p class="text-danger">
												아이디를 잊어버리신 경우 <strong>[홈페이지]</strong> 를 통해 간단한 회원정보를 확인 후
												회원가입 시 정보와 일치하면 아이디 / 비밀번호를 확인 및 재설정하실 수 있습니다.
											</p>
											<p class="fs-5 fw-bold">[아이디 / 비밀번호 찾는 방법]</p>
											<p class="text-danger">① [ 홈페이지 상단 오른쪽 > 로그인 클릭 > 아아디 찾기
												Or 비밀번호 찾기 ] 클릭 시</p>
											등록된 휴대폰, 이메일 또는 본인 인증을 통하여 아이디 확인 및 비밀번호 재설정이 가능합니다. <br>이때,
											아이디 일부가 개인정보보호를 위하여 아이디 뒷자리 일부가**로 표시되며, <br>아이디 전체 확인
											시, 아이디 전체 확인을 위한 본인 인증수단 중 한가지를 선택하여 확인해 주시면 됩니다. <br>아이디
											/ 비밀번호 모두를 잊어버리신 경우 똑같은 인증 방식으로 찾으셔야 수월하게 아이디 확인 및 비밀번호 변경이
											가능 합니다.
										</div>
									</div>
								</div>
								<div class="accordion-item">
									<h2 class="accordion-header">
										<button class="accordion-button collapsed" type="button"
											...
											<p class="text-end">
												<strong>[주문/결제/입금확인] </strong> 주문완료 후 배송지를 변경할 수 있나요?
											</p>
										</button>
									</h2>
									<div id="panelsStayOpen-collapseFive"
										class="accordion-collapse collapse">
										<div class="accordion-body">
											주문완료 후에는 상품의 <strong>주문 상태에 따라 배송지 변경 여부가 결정되며,</strong> 인터파크
											직배송 상품과 판매업체 <strong>배송 상품에 따라 배송지 변경 방법이 다릅니다.</strong> <br>
											<br> <Strong class="text-primary">[마이페이지] 에서
												배송지 변경이 가능한 주문확인 및 변경 방법 </Strong> <br>① 주문 상태가 주문접수, 결제확인,
											업체주문통보 상태이면 [마이페이지]에서 변경 가능 <br>② [마이페이지 > 쇼핑내역 > 주문내역변경
											] 주문번호 선택 후 주문내역 변경하기 클릭 후 <br> ③ 이동한 화면 아래쪽 배송지 변경하기 버튼
											클릭 ④ 새로운 배송지 정보 입력 후 [배송지변경하기] 클릭 <br>
											<br> <Strong class="text-primary">[마이페이지]에서 배송지
												변경이 불가능한 주문확인 및 변경 방법 </Strong> <br>① 주문상태가 업체발송준비중, 배송 중 상태이면
											[마이페이지] 에서 변경 불가능 <br>② 주문 상태가 업체발송준비 중이면, 판매업체 정보보기에
											기재되어 있는 연락처로 직접 판매업체 연락 후 변경 요청 <br>③ 배송 중 상태에서는 배송지 변경
											불가능 <br>
											<br> <strong class="text-primary">[배송지 변경 안내] </strong>
											<br>① 한 주문번호당 하나의 배송지만 설정하실 수 있습니다. <br>② 여러
											배송지로의배송을 원하신다면 각각 주문해 주시기 바랍니다. <br>③ 주문접수 상태부터 업체주문통보
											단계까지는 [마이페이지]에서 배송지 변경이 가능합니다. <br>④ 업체가 상품을 발송할 준비를 하고
											있는 중 배송지 변경을 하시려면 별도로 업체에 연락을 하셔야 합니다.
										</div>
									</div>
								</div>
								<div class="accordion-item">
									<h2 class="accordion-header">
										<button class="accordion-button collapsed" type="button"
											...
											<p class="text-end">
												<strong>[영수증] </strong> 전자세금계산서는 신청 후 바로 발급이 가능 한가요?
											</p>
										</button>
									</h2>
									<div id="panelsStayOpen-collapseSix"
										...
										<div class="accordion-body">
											...
											<strong>결제 완료 익월 6일까지 아래 경로를 통해서 신청 해주시기 바랍니다. <br>다만,
												발급 불가 할 경우 고객센터를 통해서 확인해주시기 바랍니다.
											</strong> <br>
											<br> 발급/출력(다운로드)은 [마이페이지 > 쇼핑내역 > 영수증 신청/발행 > 세금계산서] 에서
											해당 기간 내에 확인하실 수 있습니다.
										</div>
									</div>
								</div>
								<div class="accordion-item">
									<h2 class="accordion-header">
										<button class="accordion-button collapsed" type="button"
											...
											<p class="text-end">
												<strong>[영수증] </strong> 거래증빙서류를 확인하려면 별도의 프로그램을 설치해야 하나요?
											</p>
										</button>
									</h2>
									<div id="panelsStayOpen-collapseSeven"
										class="accordion-collapse collapse">
										<div class="accordion-body">
											증빙서류(입금증/현금영수증/신용카드매출전표/전자세금계산서)를 처음 다운로드 받으시면 고객님의 PC에 증빙서류
											관리 프로그램(TS Viewer)이 자동 설치되기 때문에 별도로 설치하실 필요가 없으며, <br>이후에는
											파일만 받으시면 됩니다. <br>
											<br> <strong>[TS Viewer (증빙서류 관리 프로그램)]</strong> <br>①
											발급된 증빙서류를 PC에 다운로드 하시면 파일 형태의 문서로 PC에 저장됩니다. <br>② 증빙서류가
											PC에 저장되는 위치는“C\Windows\TopShield\전자 문서함"이며, 디스켓 등 별도 저장 장치에
											저장하셔도 무관합니다. <br>③ PC에 저장된 증빙서류는 편리하게 보관할 수 있으며, 언제든지
											출력할 수 있습니다. 단, 출력한 신용카드매출전표 및 전자세금계산서는 법적 증빙 효력이 없습니다. <br>④
											Viewer가 자동으로 설치되지 않아 증빙서류가 다운로드가 되지 않을 경우 VIEWER 다운로드 를 클릭하신
											후 실행 또는 다운 받으시고 PC에 설치하신 뒤 증빙서류를 다운로드 하시면 됩니다. <br>⑤증빙서류(입금증/현금영수증/신용카드매출전표/전자세금계산서)를
											발급 하기 위해서는 고객님의 PC에 증빙서류 관리 프로그램(TS Viewer)이 정상적으로 설치 되어야 하나
											비정상적으로 설치되면 발급이 불가능 합니다. <br> [제어판 > 프로그램추가/삭제] 에서 증빙서류
											관리 프로그램(TS Viewer)를 삭제 후 고객님의 PC에 서 다시 다운로드 하시면 정상적으로 발급이
											됩니다.
										</div>
									</div>
								</div>
								<div class="accordion-item">
									<h2 class="accordion-header">
										<button class="accordion-button collapsed" type="button"
											...
											<p class="text-end">
												<strong>[반품/교환/AS/환불] </strong> 반품하기로 한 상품을 아직도 회수해 가지 않았어요!
											</p>
										</button>
									</h2>
									<div id="panelsStayOpen-collapseEight"
										class="accordion-collapse collapse">
										<div class="accordion-body">
											반품 상품의 반송 방법은 <strong>고객님께서 직접 택배사를 이용해 반송하시는 방법</strong>과, <strong>업체가
												보내는 택배서비스를 이용하시는 방법</strong>이 있습니다. <br>
											<br> <strong>[회수 지연 시 처리 방법]</strong> <br>① 판매업체에
											반품를 요청하시면 판매업체별로 제휴되어 있는 택배사에서 기사가 방문합니다. 회수가 지연되는 경우에는 해당
											판매업체로 연락해 주셔야 합니다. 단, 판매업체 연락처가 확인되지 않거나, 통화가 어려우시면 인터파크 쇼핑
											고객센터로 알려주세요. <br>② 고객님께서 직접 택배사를 선택하여 보내실 경우 회수를 요청한 해당
											택배사로 연락하셔서 회수 지연을 알리고 다시 회수될 수 있도록 요청해 주셔야 합니다. <br>
											<br>
											<p class="text-primary">처음 반품/회수를 요청한 곳이 아닌 다른곳으로 회수를
												요청하시면 이중으로 택배 기사가 방문 할 수 있으니, 회수 요청 방법을 변경하시려면 처음에 반품/회수를
												요청한 곳으로 연락하셔서 철회하신 후 다시 요청해 주시기 바랍니다.</p>

											<p class="text-danger">반품접수 후 90일 이내에 반품이 완료되지 않으면 해당 주문은
												정상 주문으로 자동 변경되어 판매업체로 상품대금이 정산될 수 있습니다. 고객님께서는 반품접수 후 반품이
												완료될 때까지 주문상태를 확인 부탁드립니다.</p>
										</div>
									</div>
								</div>
