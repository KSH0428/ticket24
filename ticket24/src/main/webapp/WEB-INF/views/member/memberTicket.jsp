...
<div class="page-main">
	<h2>티켓양도 예약목록</h2>
	<form action="memberTicket" id="search_form" method="get">
	<ul class="search">
	<li>
		...
		<li>
			...
			<input type="button" value="목록" onclick="location.href='memberTicket'">
		</li>
		</ul>
		</form>
			<c:if test="${count == 0}">
			...
			<table class="striped-table">
				...
				<tr class="align-center" >
					...
					<td><a href="${pageContext.request.contextPath}/ticketPay/detail?ticket_num=${ticket.ticket_num}">${ticket.ticketVO.ticket_name}</a></td>		
				</tr>			
				</c:forEach>
			</table>
